...
class FirstTab(QWidget):
    ...
    def add_suggestion_box(self): # 캐릭터 이름을 input으로 받을 수 있게 만들어야 함.
        ...
        catLabel = QLabel(self)
        catLabel.setPixmap(self.getPixmap("./photo/로키.jpg"))
        catLabel.setGeometry(20, 180, 56, 56)
        ...
        suggestionBox.setGeometry(90, 180, 250, 56)
    ...
    def add_response_box(self):
        def okay():
            ...
            responseBox2.setGeometry(275, 274, 250, 42)
        ...
        faceLabel = QLabel(self)
        faceLabel.setPixmap(self.getPixmap(""))
        faceLabel.setGeometry(539, 260, 56, 56)
        ...
        responseBox.setGeometry(275, 274, 250, 42)
        ...
        okayButton.setGeometry(290, 285, 30, 20)
        ...
        refreshButton.setGeometry(400, 285, 110, 20)
